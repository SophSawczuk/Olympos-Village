        ...
        <div>
            ...
            <div className={style.Attributes}>
                            <div className={style.Attribute}>
                                <img src={phone}/>
                                <h4>Call Us</h4>
                                <p>Make a call for your general inquiries: +223122244234 </p>
                            </div>
                            <div className={style.Attribute}>
                                <img src={email}/>
                                <h4>Email Us</h4>
            ...
            <div className={style.Contact}>
                <div className={style.TitleForm}>
                    ...
                    <p>Please feel free to get in touch using the form below. We are gonna respond you as soon as posible.</p>
                </div>
                <form onSubmit={e => handleSubmit(e)} className={style.ContactContainer}>
                    ...
                    <div className={style.Input}>
                        <span className={style.SpanSecondColumn}>Your message</span>     
                            <textarea type="text" id="message" name="message" value={input.message} placeholder="Leave your message here..." onChange={(e) => handleChange(e)} className={style.MessageInput}/>
